...
import com.noob.expression.function.MockStringReverseFunction;
import com.noob.expression.function.MockVariableResolver;
...
public class JEvalTests extends TestCase {
	...
	public void testEvaluateVariables() {
		...
		try {
			 ...
			 * These tests involve valid expressions.
			 */
			assertException(evaluator, "range(#{123},#{123})");
			evaluator.putVariable("E","{}");
			System.out.println(evaluator.evaluate("#{E}"));
			evaluator.putVariable("E", "'123123'");
			System.out.println(evaluator.evaluate("#{E}"));
